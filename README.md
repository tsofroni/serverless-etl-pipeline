...
| **Lambda** | Six Python 3.12 functions — one per pipeline stage |
...
| **CloudWatch Logs** | Automatic log groups for every Lambda and the Step Functions execution history |
...
|---------|-------|---------------|
| Lambda | 600 invocations/day × 30 s × 256 MB | ~$0.10 |
| Step Functions | 100 Express executions/day | ~$0.02 |
| DynamoDB | On-demand, ~600 writes + ~100 reads/day | ~$0.05 |
| S3 | 3 GB storage + 200 PUT + 200 GET/day | ~$0.10 |
| CloudWatch Logs | ~500 MB logs/month | ~$0.25 |
| **Total** | | **~$0.52/month** |
